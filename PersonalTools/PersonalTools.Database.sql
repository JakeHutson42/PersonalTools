...
CREATE TABLE IF NOT EXISTS CaseOpeningPriceSnapshots(PriceSnapshotId CHAR(36) NOT NULL,Name VARCHAR(160) NOT NULL,Source VARCHAR(40) NOT NULL,Currency CHAR(3) NOT NULL,PriceBasis VARCHAR(200) NOT NULL,SourceItemCount INT UNSIGNED NOT NULL,MatchedItemCount INT UNSIGNED NOT NULL,IsActive TINYINT(1) NOT NULL DEFAULT 0,ImportedUtc DATETIME(6) NOT NULL,PRIMARY KEY(PriceSnapshotId),KEY IX_CaseOpeningPriceSnapshots_Active(IsActive,ImportedUtc)) COLLATE='utf8mb4_unicode_ci' ENGINE=InnoDB;
