...
public sealed class CaseBattlesController(ICaseBattleFuncs battles, ILogger<CaseBattlesController> logger) : ControllerBase
{
    ...
    [HttpGet("invitations/pending")] public Task<ActionResult<CaseBattleInvitationObj?>> GetPendingInvitation(CancellationToken ct) => Execute(() => battles.GetPendingInvitation(UserId, ct));
