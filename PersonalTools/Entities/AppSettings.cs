...
public enum AppSettingKey { AppearanceTheme, AppearanceMode, MatrixAmbientBackground, DashboardDefaultView, DashboardMotion, DashboardWeatherUnit, SteamWebApiKey, CSFloatApiKey, CaseProfileEmoji }
...
public static class AppSettingDefinitions
{
    ...
    [
        ...
        new(AppSettingKey.CaseProfileEmoji, "Case Tycoon", "Profile avatar", "Choose the emoji or illustrated profile shown across Case Tycoon and multiplayer battles.", AppSettingInputType.Select, [("😎", "Cool"), ("🦊", "Fox"), ("🐲", "Dragon"), ("👾", "Arcade"), ("💎", "Collector"), ("🎯", "Sharpshooter"), ("🥷", "Ninja"), ("👽", "Alien"), ("🧙", "Wizard"), ("🦁", "Lion"), ("avatar:operative", "Neon operative"), ("avatar:vanguard", "Vanguard"), ("avatar:synth", "Synth pilot")]),
